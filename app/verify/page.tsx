          ...
          <div className="space-y-6">
            ...
            <section className="glass-card rounded-[32px] p-6 page-fade">
              ...
              <button
                type="button"
                onClick={() => router.push("/")}
                className="mt-6 flex w-full items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white/70 px-4 py-3 text-sm font-semibold text-slate-700 transition hover:bg-white hover:shadow"
              >
                ← Quay về trang chủ
              </button>
            </section>
